...
If you're new to Bullet Train, start with the [Bullet Train Developer Documentation](https://tailwind.bullettrain.co/docs) and the [Bullet Train Quick Start Guide](https://tailwind.bullettrain.co/docs/getting-started).
