...
class Api::V1::Scaffolding::CompletelyConcrete::TangibleThingsControllerTest < Api::Test
  unless scaffolding_things_disabled? # 🚅 skip when scaffolding.
    ...
    test "create" do
      ...
      tangible_thing_data = JSON.parse(build(:scaffolding_completely_concrete_tangible_thing, absolutely_abstract_creative_concept: @absolutely_abstract_creative_concept).to_api_json)
      tangible_thing_data.except!("id", "created_at", "updated_at")
