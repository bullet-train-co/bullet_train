...
# Core packages.
gem "bullet_train", github: "bullet-train-co/bullet_train-base", branch: "features/open-api"
gem "bullet_train-super_scaffolding", github: "bullet-train-co/bullet_train-super_scaffolding", branch: "features/open-api"
gem "bullet_train-api", github: "bullet-train-co/bullet_train-api", branch: "features/open-api"
