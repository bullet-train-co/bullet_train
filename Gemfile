...
gem "bullet_train-super_scaffolding-templates", path: "../bullet_train-super_scaffolding-templates"
...
gem "bullet_train-outgoing_webhooks-api", path: "../bullet_train-outgoing_webhooks-api"
